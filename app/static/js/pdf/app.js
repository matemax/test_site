...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, require('/static/jsui_utils.js'), require('/static/js/pdf/download_manager.js'),
      require('/static/js/pdf/pdf_history.js'), require('/static/js/pdf/preferences.js'),
      require('/static/js/pdf/pdf_sidebar.js'), require('/static/js/pdf/view_history.js'),
      require('/static/js/pdf/pdf_thumbnail_viewer.js'), require('/static/js/pdf/secondary_toolbar.js'),
      require('/static/js/pdf/password_prompt.js'), require('/static/js/pdf/pdf_presentation_mode.js'),
      require('/static/js/pdf/pdf_document_properties.js'), require('/static/js/pdf/hand_tool.js'),
      require('/static/js/pdf/pdf_viewer.js'), require('/static/js/pdf/pdf_rendering_queue.js'),
      require('/static/js/pdf/pdf_link_service.js'), require('/static/js/pdf/pdf_outline_viewer.js'),
      require('/static/js/pdf/overlay_manager.js'), require('/static/js/pdf/pdf_attachment_viewer.js'),
      require('/static/js/pdf/pdf_find_controller.js'), require('/static/js/pdf/pdf_find_bar.js'),
      require('/static/js/pdf/dom_events.js'), require('/static/js/pdf/pdfjs.js'));
  } else {
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/static/img';
//#if (FIREFOX || MOZCENTRAL || GENERIC || CHROME)
//PDFJS.workerSrc = '../build/pdf.worker.js';
//#endif
//#if !PRODUCTION
  PDFJS.cMapUrl = '/static/bcmaps/';
  PDFJS.cMapPacked = true;
  PDFJS.workerSrc = '/static/js/pdf/worker_loader.js';
//#else
