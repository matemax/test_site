...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, require('/static/js/pdf/pp.js'), require('/static/js/pdf/overlay_manager.js'),
      require('/static/js/pdf/preferences.js'), require('/static/js/pdf/pdfjs.js'));
  } else {
