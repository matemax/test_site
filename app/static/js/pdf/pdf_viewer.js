...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, require('/static/js/pdf/ui_utils.js'), require('/static/js/pdf/pdf_page_view.js'),
      require('/static/js/pdf/pdf_rendering_queue.js'), require('/static/js/pdf/text_layer_builder.js'),
      require('/static/js/pdf/annotation_layer_builder.js'),
      require('/static/js/pdf/pdf_link_service.js'), require('/static/js/pdf/dom_events.js'),
      require('/static/js/pdf/pdfjs.js'));
  } else {
